...
public class Environment extends JComponent {
    ...
    public void Setup() {
        ...
        frame.setSize(500,Toolkit.getDefaultToolkit().getScreenSize().height-200);
    ...
    public void GetEnvironment() {
        ...
        push.addActionListener(e->{
            ...
            int Year=0;
            int Month=0;
            if(GetName.getText().isBlank() ||GetDate.getText().isBlank() || GetDescription.getText().isBlank()){
                Created.setText("Fill all forms");
            }else {
        ...
        View.setSize(100,50);
        layout.putConstraint(SpringLayout.NORTH,View,frame.getHeight()-View.getHeight()-40,SpringLayout.NORTH,cp);
